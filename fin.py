...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        # self.pushButton_1.clicked.connect(self.runBar)
        ...
        # self.pushButton_2.clicked.connect(self.runBar)
        ...
        # self.pushButton_3.clicked.connect(self.runBar)
        ...
        # self.pushButton_4.clicked.connect(self.runBar)
        ...
        self.label_4.setGeometry(QtCore.QRect(240, 350, 311, 71))
        font = QtGui.QFont()
        font.setPointSize(15)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "Описание 1"))
        self.label_3.setText(_translate("Dialog", "Описание 2"))
        self.pushButton_3.setText(_translate("Dialog", "PyQT"))
        self.pushButton_1.setText(_translate("Dialog", "Django"))
        self.label_5.setText(_translate("Dialog", "Описание 4"))
        ...
        self.label_4.setText(_translate("Dialog", "Описоние 3"))
